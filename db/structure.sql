...
COMMENT ON COLUMN public.api_keys.deactivated_at IS 'When this key was deactivated. When present, this key is not valid';
...
--
-- Name: INDEX index_api_keys_on_client_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.index_api_keys_on_client_name IS 'Each client can have only one active api key';
